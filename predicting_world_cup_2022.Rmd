...
In terms of performance of the model, looking at the results I think is not a bad model. However, a short tournament with that level is more difficult to predict. The model predicted reasonable outcomes, however, many surprises happened during the cup. This model is useful to decide when there is no much knowledge or the sport or when two teams have close skills. I was surprised by some results but I realize the model was weighting more recent matches and that explain some results. For the future I would like to explore more machine learning and sport analytics I think they go well together given the massive amount of data available now. 


Finally, I predicted the outcomes of the last four matches that will be played next week: 
